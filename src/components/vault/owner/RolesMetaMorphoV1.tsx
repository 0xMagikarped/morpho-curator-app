...
interface RolesMetaMorphoV1Props {
  chainId: number;
...
export function RolesMetaMorphoV1({
  chainId,
  vaultAddress,
  currentCurator,
  currentFeeRecipient,
      ...
      <CardHeader>
        <CardTitle>
          <span className="inline-flex items-center gap-2">
            Update Roles
            <span className="px-1.5 py-0.5 text-[9px] font-mono tracking-wider uppercase bg-bg-hover border border-border-subtle text-text-tertiary">
              MetaMorpho V1
            </span>
          </span>
        </CardTitle>
